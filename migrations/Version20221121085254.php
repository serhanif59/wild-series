 ...
 */
final class Version20221121085254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD year INT DEFAULT NULL, ADD country VARCHAR(255) DEFAULT NULL, ADD slug VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program DROP year, DROP country, DROP slug');
    }
}
